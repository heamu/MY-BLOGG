    ...
    {/*Others */}
      <div className="w-full lg:w-1/2 flex flex-col gap-4">
       ...
       { posts[1]&&<div className='flex lg:h-1/3 justify-between gap-4'>
         {posts[1].img&&<Image src={posts[1].img} className="rounded-3xl object-cover w-1/3 aspect-video"/>
         }{/* details and title */}
           <div className="w-2/3">
              {/* details */}
        ...
        { posts[2]&&<div className='flex lg:h-1/3 justify-between gap-4'>
         {posts[2].img&&<Image src={posts[2].img} className="rounded-3xl object-cover w-1/3 aspect-video"/>
         }{/* details and title */}
           <div className="w-2/3">
              {/* details */}
              <div className="flex items-center gap-4 text-sm lg:text-base mb-4">
        ...
        { posts[3]&&<div className='flex lg:h-1/3 justify-between gap-4'>
         {posts[3].img&&<Image src={posts[1].img} className="rounded-3xl object-cover w-1/3 aspect-video"/>
         }{/* details and title */}
           <div className="w-2/3">
              {/* details */}
              <div className="flex items-center gap-4 text-sm lg:text-base mb-4">
